...
var taskInput=document.getElementById("todo__add-input");//Add a new task.
var addButton=document.getElementsByTagName("button")[0];//first button
var incompleteTaskHolder=document.getElementById("todo__incomplete-list");//ul of #incompleteTasks
var completedTasksHolder=document.getElementById("todo__completed-list");//completed-tasks
...
var addTask=function(){
    ...
    //Create a new list item with the text from the #todo__add-input:
...
//select ListItems children
    ...
    var editButton=taskListItem.querySelector("button.todo__btn-edit");
    var deleteButton=taskListItem.querySelector("button.todo__btn-delete");
